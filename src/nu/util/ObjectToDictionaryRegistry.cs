...
namespace nu.util
{
	...
	{
		readonly Dictionary<Type, Func<object, IDictionary<string, object>>> _cache;
		readonly Dictionary<string, object> _default;
		readonly ReaderWriterLockSlim _lock;

		public ObjectToDictionaryRegistry()
		{
		...
		Func<object, IDictionary<string, object>> GetObjectToDictionaryConverter(object item)
		{
